...
class LedInteractionDialog extends StatelessWidget {
  const LedInteractionDialog({
  ...
  Widget build(BuildContext context) => Consumer<BleDeviceInteractor>(
      builder: (context, interactor, _) => _LedInteractionDialog(
...
class _LedInteractionDialog extends StatefulWidget {
  const _LedInteractionDialog({
    required this.characteristic,
  ...
  @override
  _LedInteractionDialogState createState() => _LedInteractionDialogState();
}

class _LedInteractionDialogState extends State<_LedInteractionDialog> {
